...
const App: React.FC = () => {
  ...
  const [isSignedUp, setIsSignedUp] = useState<boolean>(false); // 회원가입 상태
  const [accountId, setAccountId] = useState<number | null>(null); // account ID 상태
                ...
                <Route
                  ...
                  element={
                    isSignedUp ? (
                      ...
                      <SignupModal closeModal={handleSignup} />
                    )
                  }
                />
                <Route
